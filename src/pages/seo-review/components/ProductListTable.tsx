                      ...
                      <div className="flex items-center justify-end gap-1">
                          ...
                          className={`p-1.5 rounded-lg text-xs font-semibold transition ${
                            product.isSyncing || product.isReverting
                              ...
                              : product.reviewDecision === "approved"
                                ...
                                : "text-emerald-400 hover:bg-emerald-950/60 border border-emerald-800/40 hover:border-emerald-600 cursor-pointer"
                          }`}
                        ...
                        {product.shopifySyncStatus === "synced" && onRetrySync ? (
                          <button
                            ...
                            onClick={() => onRetrySync(product.id)}
                            disabled={product.isSyncing}
                            className="rounded-lg border border-teal-500/30 px-1.5 py-1 text-xs text-teal-300 hover:bg-slate-800 disabled:cursor-not-allowed disabled:text-slate-500"
                            aria-label={
                              product.storeId && currentStoreId && product.storeId.toLowerCase() !== currentStoreId.toLowerCase()
                          ...
                          className={`p-1.5 rounded-lg text-xs font-semibold transition ${
                            product.isSyncing || product.isReverting
                              ...
                              : product.reviewDecision === "rejected"
                                ...
                                : "text-rose-400 hover:bg-rose-950/60 border border-rose-800/40 hover:border-rose-600 cursor-pointer"
                          }`}
                          aria-label="Từ chối"
                        >
                          ✕
