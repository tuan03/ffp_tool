...
export const mockThemeClusters: readonly ThemeCluster[] = [
  {
    ...
    keywords: [
      { keyword: "spooky cute ghost pattern", rank: 1, pct_growth_mom: 85, pct_growth_wow: 32, status: "accepted", markets: ["US", "CA", "DE"], trend_types: ["growing", "seasonal"], occurrences: 4 },
      { keyword: "pastel ghost reading books", rank: 4, pct_growth_mom: 72, pct_growth_wow: 28, status: "accepted", markets: ["US", "FR"], trend_types: ["growing"], occurrences: 2 },
      { keyword: "cute ghost doodle wallpaper", rank: 7, pct_growth_mom: 64, pct_growth_wow: 21, status: "accepted", markets: ["US", "CA", "ES"], trend_types: ["monthly"], occurrences: 3 },
    ],
    avg_growth_mom: 73.7,
    avg_growth_wow: 27.0,
    sample_queries: [
  ...
  },
  {
    ...
    keywords: [
      { keyword: "gothic celestial tarot pattern", rank: 2, pct_growth_mom: 94, pct_growth_wow: 41, status: "accepted", markets: ["US", "DE", "FR", "IT"], trend_types: ["seasonal", "growing"], occurrences: 5 },
      { keyword: "mystical moon star textile print", rank: 5, pct_growth_mom: 78, pct_growth_wow: 30, status: "accepted", markets: ["US", "CA"], trend_types: ["monthly"], occurrences: 2 },
      { keyword: "witchy esoteric dark academia art", rank: 9, pct_growth_mom: 68, pct_growth_wow: 22, status: "accepted", markets: ["DE", "ES"], trend_types: ["growing"], occurrences: 2 },
    ],
    avg_growth_mom: 80.0,
    avg_growth_wow: 31.0,
    sample_queries: [
...
export const mockTrendDiscoveryResult: TrendDiscoveryResult = {
  ...
  query_matrix_stats: {
    ...
    failed_queries: 0,
    markets: ["US", "CA", "DE", "FR", "ES", "IT"],
    trend_types: ["growing", "monthly", "seasonal"],
    raw_keywords_count: 900,
    unique_keywords_count: 704,
  },
