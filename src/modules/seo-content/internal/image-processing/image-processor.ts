  ...
  async process(input: ImageProcessingInput): Promise<ImageProcessingResultWithMetadata> {
    ...
    for (let i = 0; i < input.images.length; i++) {
      ...
      const alt = generateAltText({
        ...
        physicalProductIdentity: input.physicalProductIdentity,
        typographyVisibleTexts: input.typographyVisibleTexts,
        typographyStyleSummary: input.typographyStyleSummary,
