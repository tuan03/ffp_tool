...
export const autoSeoMockProducts: readonly AutoSeoProductCandidate[] = [
  {
    ...
    descriptionHtml: "<p>Premium 11oz ceramic mug with <strong>glossy</strong> finish.</p>\n<div>Microwave and dishwasher safe.</div>",
    niche: "drinkware",
    images: [
      {
  ...
  },
  {
    ...
    descriptionHtml: "<div>Instant download printable &amp; tablet PDF planner.</div>",
    niche: "stationery",
    images: [],
  },
  {
    ...
    descriptionHtml: "<span>Cozy 50/50 cotton-poly fleece with matching drawstrings.</span>",
    images: [
      {
